...
public class FileBossTrans : MonoBehaviour
{
    ...
    [Header("타이밍 설정")]
    public float stage1StartTime = 90.7f;   // 1:30.7 - 플레이어 창 이동 시작 (빠)
    public float stage2StartTime = 91.9f;   // 1:31.9 - 화면 어두워짐 시작 (바)
    public float stage3StartTime = 94.0f;   // 1:34.0 - 팡! 효과 (밤)
